        ...
        return (
          <div key={bloque} className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div className="px-4 py-3 bg-green-50 border-b border-green-100">
              <h3 className="font-semibold text-green-900">Bloque {bloque}</h3>
            </div>
                  ...
                  {bloqueMaterias.map(materia => (
                    <tr key={materia.id} className="hover:bg-gray-50">
                      <td className="px-4 py-3">
                        <span className="inline-flex items-center justify-center w-10 h-8 bg-green-100 text-green-800 text-sm font-semibold rounded">
